...
2. Download the code:
    * By [downloading directly](https://github.com/eeshaanrehani/imageJ-tracing/archive/refs/heads/follicle_windows_usask.zip).
3. Enter the directory with the git repository: `cd /path/to/imageJ-tracing-follicle_windows_usask/`.
